...
const TabEditable = props => {
  ...
  const add = () => {
    ...
    if (props.newpane) newpane = { ...newpane,
      content: { ...props.newpane
      }
    }; //{title:"",content:""}
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Tabs, {
    ...
    activeKey: activeKey,
    onEdit: onEdit
  }, panes && panes.map(pane => /*#__PURE__*/React.createElement(TabPane, {
    tab: pane.title,
    key: pane.key,
    closable: pane.closable
  }, pane.content))), panes && panes.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center"
    }
  }, /*#__PURE__*/React.createElement(ButtonNew, {
    onClick: add
  })));
};
