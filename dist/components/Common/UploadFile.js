...
import { AiOutlineFileExcel, AiOutlineFileGif, AiOutlineFileJpg, AiOutlineFileZip, AiOutlineFileImage, AiFillFileUnknown, AiOutlineFileMarkdown } from "react-icons/ai";
...
const UploadFile = props => {
        ...
        avatar: {
          ...
          icon: (() => {
            switch (filetype) {
              case "xls":
              case "xlsx":
                return /*#__PURE__*/React.createElement(AiOutlineFileExcel, null);

              default:
                return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(AiFillFileUnknown, null));

              case "csv":
                return /*#__PURE__*/React.createElement(GrDocumentCsv, null);

              case "txt":
                return /*#__PURE__*/React.createElement(GrDocumentTxt, null);

              case "zip":
                return /*#__PURE__*/React.createElement(AiOutlineFileZip, null);

              case "gif":
                return /*#__PURE__*/React.createElement(AiOutlineFileGif, null);

              case "jpg":
                return /*#__PURE__*/React.createElement(AiOutlineFileJpg, null);

              case "png":
                return /*#__PURE__*/React.createElement(AiOutlineFileImage, null);

              case "nmf":
                return /*#__PURE__*/React.createElement(AiOutlineFileMarkdown, null);
            }
          })()
        },
        content: k.filepath ? /*#__PURE__*/React.createElement("span", {
          style: {
            color: "#4169E1"
          }
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    ref: fileRef,
    accept: accept
  }), /*#__PURE__*/React.createElement(FolderOpenOutlined, null), " Select file..."), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "btn btn-success ",
    onClick: onUploadHandler
  }, "Upload")), listData && listData.length > 0 && /*#__PURE__*/React.createElement(AntList, {
    listData: listData,
    search: false,
    loading: false,
  ...
  }, open && /*#__PURE__*/React.createElement(Spin, null)));
};
