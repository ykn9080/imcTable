...
import { AiOutlineEyeInvisible, AiOutlineEye, AiOutlineCalculator, AiOutlineUngroup, AiOutlineGroup } from "react-icons/ai";
...
const EasyTable = props => {
  ...
  useEffect(() => {
    ...
    if (data) {
      ...
      if (data?.setting?.groupby) setGroupbyTable(data.setting.groupby, rtn.dtlist);
    }
  }, [data]);
  ...
  const columnEditFilter = (columns, colsetting) => {
    ...
    if (columns) columns.map((column, i) => {
      const colbtns = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Button, {
        type: "link",
        size: "small",
        style: {
          color: "gray",
        ...
        type: "link",
        size: "small",
        icon: /*#__PURE__*/React.createElement(GrFormClose, null)
      })));
      column = { ...column,
        title: /*#__PURE__*/React.createElement("span", null, column.titletext, " ", colbtns)
      };
  ...
  const menu = [{
    title: delColumnShow ? /*#__PURE__*/React.createElement(Tooltip, {
      title: "Show deleted columns",
      style: {
        zIndex: 10000
      }
    }, /*#__PURE__*/React.createElement(AiOutlineEye, null)) : /*#__PURE__*/React.createElement(Tooltip, {
      title: "Hide deleted columns"
    }, /*#__PURE__*/React.createElement(AiOutlineEyeInvisible, null)),
    onClick: () => {
    ...
    title: /*#__PURE__*/React.createElement(Tooltip, {
      title: "Revert column delete",
      placement: "left"
    }, /*#__PURE__*/React.createElement(GrRevert, null)),
    onClick: () => {
      if (window.confirm("Are you sure to reset column?")) handleAction("revertcolumn");
    }
  }, {
    title: /*#__PURE__*/React.createElement(Tooltip, {
      title: "Add calculated column",
      placement: "left"
    }, /*#__PURE__*/React.createElement(AiOutlineCalculator, null)),
    onClick: () => handleAction("calc")
  }, {
    title: !grpby ? /*#__PURE__*/React.createElement(Tooltip, {
      title: "Execute group by",
      placement: "left"
    }, /*#__PURE__*/React.createElement(AiOutlineGroup, null)) : /*#__PURE__*/React.createElement(Tooltip, {
      title: "Cancel group by",
      placement: "left"
    }, /*#__PURE__*/React.createElement(AiOutlineUngroup, null)),
    onClick: () => {
      handleAction(!grpby ? "groupby" : "cancelgroupby");
    }
  }];
  return /*#__PURE__*/React.createElement(React.Fragment, null, columns && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
      marginRight: 5,
      height: "auto"
    }
  }, edit === true && /*#__PURE__*/React.createElement(React.Fragment, null, grpby && /*#__PURE__*/React.createElement(AntFormDisplay, grpby), /*#__PURE__*/React.createElement(Row, {
    justify: "end"
  }, /*#__PURE__*/React.createElement(Col, null, /*#__PURE__*/React.createElement(Tooltip, {
    title: "Save temporarily"
  }, /*#__PURE__*/React.createElement(IconButton, {
    "aria-label": "save",
    onClick: saveTemp
  }, /*#__PURE__*/React.createElement(SaveOutlined, null)))), /*#__PURE__*/React.createElement(Col, null, /*#__PURE__*/React.createElement(MoreMenu, {
    menu: menu,
    handleAction: handleAction
  })))), /*#__PURE__*/React.createElement(DraggableColumns, {
    columns: columns,
    data: filtered,
    onDragEnd: onDragEnd //tbsetting={{ size: "small" }}
    ,
    tbsetting: tbsetting
    ...
    destroyOnClose: true,
    footer: []
  }, /*#__PURE__*/React.createElement(AntFormDisplay, {
...
export const baseData = data1 => {
  ...
  let colArr,
      colCompare,
      colArr1 = [],
      diffnum = 0; //setting.reset = delColumnShow;
  //if (!size) size = "small";
...
const filterList = (filList, columnList) => {
  ...
  if (filList && typeof filList === "object") filList.map((a, j) => {
    columnList.map((b, m) => {
      if (b.calculaterule) {
        a = { ...a,
...
const calcMaker = (rule, row) => {
  ...
  const parseRule = splitt => {
    spl1 = splitt.split("$"); //["", "wgt/3+10"];

    spl1.map((k, i) => {
      rkey.map((s, j) => {
        if (k.toLowerCase().indexOf(s.toLocaleLowerCase()) > -1) spl1.splice(i, 1, k.replace(s, rval[j]));
        return null;
      });
      return null;
    });
...
const makeColumn = (columns, colsetting) => {
  let col = [],
      dtt = []; // if (editable === false) col = columns;
  // else {
  ...
  columns.map((column, i) => {
    ...
    let obj = {
      ...
      render(text, record) {
        let styleset = {};
        if (record[`color.${obj.origin}`]) styleset = {
          background: record[`color.${obj.origin}`]
        };
        return {
          props: {
            style: { ...styleset
  ...
  return col; //return { col: col, dt: dtt };
};
...
export const UpdateColnData = data => {
  ...
  let ds = data.setting;
  colArr.map((k, i) => {
    if (!(ds && ds.delarr && ds.delarr.indexOf(k.key) > -1) | ds.reset) columnList.push(k);
    return null;
  });
